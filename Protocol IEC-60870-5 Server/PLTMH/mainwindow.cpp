    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle( tr("60870-5-104 PLTMH") );
...
void MainWindow::SendAllValueToIEC_Control()
{
    //PLTMH
    //=====================================================================================================================
    SendValueToIEC_Pltmh("SELECT id,outvalue FROM all_control_protocol where status='PLTMH' order by id desc limit 1",1);
}

void MainWindow::SendValueToIEC_Pltmh(QString Query,int IOA)
{
...
{
    SendValueToIEC_PltmhW  ("SELECT id,outvalue FROM AllOutControl_protocol where status='PLTMHW' order by id desc limit 1",24);
    SendValueToIEC_PltmhVAR("SELECT id,outvalue FROM AllOutControl_protocol where status='PLTMHVAR' order by id desc limit 1",25);
}

void MainWindow::SendValueToIEC_PltmhW(QString Query, int IOA)
{
...
void MainWindow::SendValueToIEC_PltmhVAR(QString Query, int IOA)
{
    //setpoint command kirim ke iec
    iec_obj obj;
    QSqlQuery qry;
...
void MainWindow::GetValue()
{
    ...
    ui->leIPRemoto->setText(s.value("IP PLTMH").toString());
    ui->leAsduAddr->setText(s.value("ASDU PLTMH").toString());
    s.endGroup();
...
void MainWindow::INSERTALLDATA()
{
    ...
    InsertAllRST_COSPHI();
    DataIn_Status_Radiation();
}

void MainWindow::DataIn_Status()
{
    DataIn_Pltmh("select count(id) from in_pltmh limit 1",
                 "insert into in_pltmh (timestamps,pltmh) values(:p_1,:p_2) ",
                 "select pltmh from in_pltmh order by id desc limit 1",timestamp,dataku[0]);
}

void MainWindow::DataIn_Status_RTU()
{
    Datain_RTU_PLTMH("select count(id) from in_cb_rtu_pltmh limit 1",
                     "insert into in_cb_rtu_pltmh (timestamps,value) values(:p_1,:p_2) ",
                     "select value from in_cb_rtu_pltmh order by id desc limit 1",timestamp,dataku[1]);
...
void MainWindow::DataIn_Status_CB()
{
    ...
    Datain_CB_PLTMH("select count(id) from in_cb_pltmh limit 1",
                    "insert into in_cb_pltmh (timestamps,aPltmh,aPltmh_b) values(:p_1,:p_2,:p_3) ",
                    "select aPltmh,aPltmh_b from in_cb_pltmh order by id desc limit 1",timestamp,dataku[2],dataku[3]);
}
...
void MainWindow::DataIn_Status_IN_POWER()
{
    ...
    Datain_PLTMH_W_VAR("select count(id) from in_power_pltmh limit 1",
                       "insert into in_power_pltmh (timestamps,PltmhW,PltmhVar) values(:p_1,:p_2,:p_3) ",
                       "select PltmhW,PltmhVar from in_power_pltmh order by id desc limit 1",timestamp,dataku[4],dataku[5]);
}

void MainWindow::DataIn_Status_Radiation()
{
    DataIn_Radiation("select count(id) from mon_radiation limit 1",
                     "insert into mon_radiation(timestamps,radiation)values(:p_1,:p_2)",
                     "select radiation from mon_radiation order by id desc limit 1",timestamp,dataku[21]);
}
...
void MainWindow::DataIn_Status_Registry()
{
    ...
    set.setValue("DI_PLTMH",dataku[0]);
    set.endGroup();
}

void MainWindow::DataIn_Radiation(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString Value_IN)
{
    if(Value_IN!=NULL)
    {
...
void MainWindow::InsertAllRST()
{
    ...
    for (z=15; z<20;z++)
    {
        if (dataku[z]!=NULL)
        {
            InsertPLTMH_Monitor("select count(id) from mon_pltmh limit 1",
                                "INSERT INTO mon_pltmh (timestamps, pltmhVR, pltmhVS,pltmhVT,pltmhAR,pltmhAS,pltmhAT) VALUES ("+formatparam+")",
                                "select pltmhVR, pltmhVS,pltmhVT,pltmhAR,pltmhAS,pltmhAT from mon_pltmh order by id desc limit 1 ",
                                timestamp,
                                dataku[15],dataku[16],
                    dataku[17],dataku[18],
                    dataku[19],dataku[20]);
...
void MainWindow::InsertAllRST_ActiveReactive()
{
    ...
    for (int a=6; a<8;a++)
    {
        if (dataku[a]!=NULL)
        {
            InsertPLTMH_Active("select count(id) from mon_active_pltmh limit 1",
                               "insert into mon_active_pltmh ("+ParamDB+") values ("+Paramvalue+")",
                               "select ActiveR,ActiveS,ActiveT from mon_active_pltmh order by id desc limit 1",
                               timestamp,
    ...
    for (int a=9; a<11;a++)
    {
        if (dataku[a]!=NULL)
        {
            InsertPLTMH_ReActive("select count(id) from mon_reactive_pltmh limit 1",
                                 "insert into mon_reactive_pltmh ("+ParamDBR+") values ("+Paramvalue+")",
                                 "select ReactiveR,ReactiveS,ReactiveT from mon_reactive_pltmh order by id desc limit 1",
                                 timestamp,
...
void MainWindow::InsertAllRST_COSPHI()
{
    ...
    for (int d=12;d<14;d++)
    {
        if(dataku[d]!=NULL)
        {
            InsertPLTMH_COSPHI("select count(id) from mon_cosphi_pltmh limit 1",
                               "insert into mon_cosphi_pltmh(timestamps,CosPhiR,CosPhiS,CosPhiT) values("+formatparam+")",
                               "select CosPhiR,CosPhiS,CosPhiT from mon_cosphi_pltmh order by id desc limit 1 ",
...
void MainWindow::DataIn_Pltmh(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN)
{
    if(Value_IN!=NULL)
    {
        QSqlQuery qry,qry_d,qry_count;
...
void MainWindow::Datain_RTU_PLTMH(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN)
{
    // PLTMH
    if(Value_IN!=NULL )
    {
...
void MainWindow::Datain_CB_PLTMH(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN_1,QString Value_IN_2)
{
    //PLTMH
            ...
            else
            {
                ...
                if (qry_d.next())
                {
                    ...
                    if(Value_IN_1!=val || Value_IN_2!=val2 )
                    {
                        ...
                        qry.bindValue(":p_3",Value_IN_2);
                        qry.exec();
                        // if (Value_IN_1=="0" || Value_IN_2=="0" && Value_IN_1=="0" || Value_IN_2=="1" && Value_IN_1=="1" || Value_IN_2=="0" )
                        //{
                        //                        Set_CB_Pltmh("insert into AllOutControl_protocol(timestamps,operatorname,status,outvalue,ioa,information) values(:p_1,:p_2,:p_3,:p_4,:p_5,:p_6)",
...
void MainWindow::Datain_PLTMH_W_VAR(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString Value_IN_1, QString Value_IN_2)
{
    //================================= PLTMH MON W/VAR ================================================
    if(Value_IN_1!=NULL && Value_IN_2!=NULL)
    {
...
void MainWindow::InsertPLTMH_Monitor(QString QueryCount,QString QueryInsert, QString Validation_IN,QString Timestamp,QString VR,QString VS,QString VT,QString AR,QString AS,QString AT)
{
...
void MainWindow::InsertPLTMH_Active(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString VR, QString VS, QString VT)
{
    QSqlQuery query_get,q_data,qry_count;
    QString r,s,t,count;
...
void MainWindow::InsertPLTMH_ReActive(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString VR, QString VS, QString VT)
{
    QSqlQuery query_get,q_data,qry_count;
    QString r,s,t,count;
...
void MainWindow::InsertPLTMH_COSPHI(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString PHIR, QString PHIS, QString PHIT)
{
...
void MainWindow::Set_RTU_Pltmh(QString QueryInsert, QString Timestamp, QString Value_IN)
{
    QSqlQuery query;
    query.prepare(QueryInsert);
    query.bindValue(":p_1",Timestamp);
    query.bindValue(":p_2","Server Protocol");
    query.bindValue(":p_3","RTUPLTMH");
    query.bindValue(":p_4",Value_IN);
    query.bindValue(":p_5","3");
    query.bindValue(":p_6","RTU PLTMH Condition is OFF !");
    query.exec();
}

void MainWindow::Set_CB_Pltmh(QString QueryInsert, QString Timestamp, QString Value_IN ,  QString Value_IN2)
{
    QSqlQuery query;
    QString info;
    query.prepare(QueryInsert);
    ...
    {
        info="CB PLTMH 1 and CB PLTMH 2 Condition is OFF ";
        query.bindValue(":p_3","CBPLTMH");
    ...
    {
        info="CB PLTMH 1 Condition is ON and CB PLTMH 2 Condition is OFF ";
        query.bindValue(":p_3","CBPLTMH");
    ...
    {
        info="CB PLTMH 1 Condition is OFF and CB PLTMH 2 Condition is ON ";
        query.bindValue(":p_3","CBPLTMH");
...
void MainWindow::ConnectionRTU()
{
    ...
    QSqlQuery qry_2;
    QString value="0";
    qry_2.prepare("insert into in_cb_rtu_pltmh (timestamps,value) values (:p_1,:p_2)");
    qry_2.bindValue(":p_1",time);
    qry_2.bindValue(":p_2",value);
    qry_2.exec();
    //    Set_RTU_Pltmh("insert into AllOutControl_protocol(timestamps,operatorname,status,outvalue,ioa,information) values(:p_1,:p_2,:p_3,:p_4,:p_5,:p_6)",
    //                  time,value);
