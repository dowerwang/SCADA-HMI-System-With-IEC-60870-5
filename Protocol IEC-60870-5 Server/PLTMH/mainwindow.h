...
private slots:
    ...
    //==============================================================================
    void DataIn_Pltmh(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN);
    void Datain_RTU_PLTMH(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString Value_IN);
    void Datain_CB_PLTMH(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN_1,QString Value_IN_2);
    void Datain_PLTMH_W_VAR(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString Value_IN_1, QString Value_IN_2);
    //==============================================================================
    ...
    void DataIn_Status_Radiation();
    void DataIn_Status_Registry();
    //==============================================================================
    // GET RADIATION
    //==============================================================================
    void DataIn_Radiation(QString QueryCount,QString QueryInsert,QString Validation_IN,QString Timestamp,QString Value_IN);
    //==============================================================================
    // GET CLOCK AND DB
    //==============================================================================
    ...
    //==============================================================================
    void InsertAllRST();
    void InsertPLTMH_Monitor(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp, QString VR, QString VS, QString VT, QString AR, QString AS, QString AT);
    //==============================================================================
    //INSERT ALL DATA MONITORING RST ACTIVE REACTIVE
    //==============================================================================
    void InsertAllRST_ActiveReactive();
    void InsertPLTMH_Active(QString QueryCount,QString QueryInsert, QString Validation_IN,QString Timestamp,QString VR,QString VS,QString VT);
    void InsertPLTMH_ReActive(QString QueryCount,QString QueryInsert, QString Validation_IN,QString Timestamp,QString VR,QString VS,QString VT);
    //==============================================================================
    //INSERT ALL DATA MONITORING RST COS PHI
    //==============================================================================
    void InsertAllRST_COSPHI();
    void InsertPLTMH_COSPHI(QString QueryCount, QString QueryInsert, QString Validation_IN, QString Timestamp,QString PHIR,QString PHIS,QString PHIT);
    //==============================================================================
    //LOG TO ALARMLIST
    //==============================================================================
    void Set_RTU_Pltmh(QString QueryInsert,QString Timestamp,QString Value_IN);
    void Set_CB_Pltmh(QString QueryInsert, QString Timestamp, QString Value_IN, QString Value_IN2);
...
private:
    ...
    // control all pltmh
    void SendValueToIEC_Pltmh(QString Query, int IOA);
    //=====================================================
    // CONTROL VALUE TO IEC 104 SET POINT
    //=====================================================
    // control all setpoint
    void SendAllValueToIEC_SetPoint();
    // control setpoint pltmh
    void SendValueToIEC_PltmhW(QString Query, int IOA);
    void SendValueToIEC_PltmhVAR(QString Query, int IOA);
    ...
    double dataValue[25]; //addr default iec
    QString dataku[25],timestamp;
    QTimer *waktu;
    //QTimer *jam;
    QTimer *clockSync;
    // BDTR Related
